...
<nav class="navbar navbar-default" role="navigation">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="btn navbar-left" style="padding-top: 14px;" href="search.jsp">Advanced Search</a>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-envelope"></span></a>
            <div class="dropdown-menu" role="menu">
            <div class="media">
              <a class="media-left" href="#">
               <img src="http://placehold.it/64x64&text=Mirchu.net" alt="ALT NAME">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Example Name <span class="caret"></span></a>
